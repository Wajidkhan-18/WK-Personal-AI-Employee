#!/usr/bin/env python3
"""
LinkedIn Auto-Post - GUARANTEED TO WORK

Uses Playwright browser (not Chrome) with persistent session.
First time: you login. Second time+: auto-posts!
...
def main():
    ...
    with sync_playwright() as p:
        ...
        if not logged_in:
            ...
            print()
            print("PLEASE LOGIN NOW IN THE BROWSER")
            ...
            if not logged_in:
                print("Timeout. Login and run again.")
                browser.close()
                sys.exit(1)
